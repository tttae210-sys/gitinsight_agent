...
def generate_final_report(state: InterviewState) -> dict:
    ...
    messages = [
        SystemMessage(content=(
            ...
            "## 📊 면접 종합 평가\n"
            "- 총 질문 수, 합격/불합격 개수, 평균 점수를 마크다운 표로 요약\n"
            ...
            "## 🛠️ 소스코드 리팩토링 제안\n"
            "- 실제 파일명과 라인 번호를 인용하여 개선 방향 제시\n"
            "- 가능하면 개선 예시 코드블록 포함 (Before/After)\n"
            "- 예: 'app/main.py 15번 줄의 DB 커넥션을 async context manager로 변경 권장'\n\n"
            "## 🎓 학습 로드맵 (4주 플랜)\n"
            "- Week 1~4로 나눠서 구체적 학습 주제와 실습 과제 제시\n"
            "- 각 주차마다 체크리스트 형태로 작성 (- [ ] 항목명)\n"
            "- 예: Week 1: 예외 처리 마스터 → Python Exception Hierarchy 학습, custom exception 설계 실습\n\n"
            "## 📚 추천 학습 자료\n"
            "- 공식 문서, 책, 온라인 강의 등 실제 존재하는 자료 3~5개 추천\n"
            "- URL 링크는 추가하지 말고 제목과 저자/강사명만 작성\n\n"
            "## 💬 면접관 한마디\n"
